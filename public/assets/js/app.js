!(function (t) {
    ...
    const BootstrapMin = window.BootstrapMin;
    const AppCss = window.AppCss;
    const BootstrapRtl = window.BootstrapRtl;
    const AppRtl = window.AppRtl;
    ...
    function s(e) {
        ...
        "light-mode-switch" === e
            ? (t("html").removeAttr("dir"),
              ...
              t("#bootstrap-style").attr( "href", BootstrapMin),
            ...
            : 1 == t("#rtl-mode-switch").prop("checked") &&
              ...
              (t("#light-mode-switch").prop("checked", !1),
              t("#dark-mode-switch").prop("checked", !1),
              t("#bootstrap-style").attr("href", BootstrapRtl),
              t("#app-style").attr("href", AppRtl),
              t("html").attr("dir", "rtl"),
              document.body.setAttribute("data-bs-theme", "light"),
              document.body.setAttribute("data-topbar", "light"),
