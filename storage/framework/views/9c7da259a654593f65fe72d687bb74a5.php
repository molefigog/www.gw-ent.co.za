...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-gray-500">
                   LSL <?php echo e($user->balance); ?>

                </p>
            </div>

            <!--[if BLOCK]><![endif]--><?php if($musicCount > 0): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.link','data' => ['color' => 'gray','href' => ''.e(url('artist', str_replace(' ', '_', $user->name))).'','icon' => 'heroicon-m-musical-note','class' => 'btn-outline']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','href' => ''.e(url('artist', str_replace(' ', '_', $user->name))).'','icon' => 'heroicon-m-musical-note','class' => 'btn-outline']); ?>
                <?php echo e(__('Music')); ?> (<?php echo e($usermusic); ?>)
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/gw-ent/htdocs/www.gw-ent.co.za/resources/views/user-widget.blade.php ENDPATH**/ ?>