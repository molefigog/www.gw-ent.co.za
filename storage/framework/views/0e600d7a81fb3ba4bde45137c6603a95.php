            ...
            <div class="input-group mb-2">
                <div class="input-group-prepend">
                    <div class="input-group-text">
                        <img src="<?php echo e(asset('assets/vcl1.png')); ?>" alt="" style="width: 24px; height: 24px;">
                    </div>
                </div>
                ...
                <button button type="submit" class="btn btn-outline-success btn-sm" wire:loading.attr="disabled">
                    <span wire:loading.remove> Pay M<?php echo e($amount); ?></span>
                    <span wire:loading>
...
<?php /**PATH /home/gw-ent/htdocs/www.gw-ent.co.za/resources/views/livewire/payment.blade.php ENDPATH**/ ?>