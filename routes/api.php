...
//         'input_ThirdPartyConversationID' => 'GW' . rand(),
...
//     ]);
// });
// Route::get('/b2c', function (Request $request) {
...
Route::middleware(['auth:api'])->group(function () {
	...
	Route::get('users/index/{filter?}/{filtervalue?}', [UsersController::class, 'index']);
	Route::get('users/view/{rec_id}', [UsersController::class, 'view']);
	Route::any('account/edit', [AccountController::class, 'edit']);
...
Route::post('auth/validateotp', [AuthController::class, 'validateotp']);
Route::post('auth/resendotp', [AuthController::class, 'resendotp']);

Route::get('auth/verifyemail', [AuthController::class, 'verifyemail'])->name('verification.verify');
Route::post('auth/resendverifyemail', [AuthController::class, 'resendverifyemail']);
